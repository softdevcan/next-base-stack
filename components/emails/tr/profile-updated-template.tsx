...
export const ProfileUpdatedTemplate = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Profil bilgileriniz güncellendi</Preview>
      <Tailwind>
          ...
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]">
            ...
            <Section className="bg-[#f0f9ff] rounded p-4 my-4 border border-[#93c5fd]">
              <Text className="text-[#1e3a8a] text-[12px] leading-[20px] m-0">
                <strong>Güncelleme Zamanı:</strong> {updateTime}
              </Text>
              <Text className="text-[#1e3a8a] text-[12px] leading-[20px] m-0 mt-2">
                <strong>Güncellenen Alanlar:</strong>
              </Text>
            ...
            <Text className="text-black text-[14px] leading-[24px]">
              Eğer bu değişiklikleri siz yapmadıysanız, lütfen derhal hesap ayarlarınızı kontrol
              edin.
            </Text>
            ...
            <Text className="text-[#666666] text-[12px] leading-[24px]">
              Profil değişiklikleri hakkında sizi bilgilendiriyoruz.
            </Text>
          </Container>
        </Body>
      </Tailwind>
